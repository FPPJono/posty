...
bot.on('ready', () => {
    ...
    const embed = {"description": "```To get a timezone role,\njust react to this message with the emote\nthats next to the time zone role you want```\n*if your time zone isnt here,\nplease send it in <#425570477281378305>*","color": 965737,"fields": [{"name": ":regional_indicator_a:","value": "AZ (UTC - 7)"},{"name":":regional_indicator_b:","value": "Central Time (UTC - 6)"},{"name":":regional_indicator_c:","value": "NZ (UTC + 12)"},{"name":":regional_indicator_d:","value": "PST (UTC - 8)"}]};
